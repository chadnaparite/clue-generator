...
namespace CluedIn.Crawling.Chad2.Infrastructure.Installers
{
    public class InstallComponents : IWindsorInstaller
    {
        public void Install(IWindsorContainer container, IConfigurationStore store)
        {
            container
                ...
                .Register(Component.For<IChad2ClientFactory>().AsFactory())
                .Register(Component.For<Chad2Client>().LifestyleTransient());
