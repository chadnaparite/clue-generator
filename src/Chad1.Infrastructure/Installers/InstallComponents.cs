...
namespace CluedIn.Crawling.Chad1.Infrastructure.Installers
{
    public class InstallComponents : IWindsorInstaller
    {
        public void Install(IWindsorContainer container, IConfigurationStore store)
        {
            container
                ...
                .Register(Component.For<IChad1ClientFactory>().AsFactory())
                .Register(Component.For<Chad1Client>().LifestyleTransient());
