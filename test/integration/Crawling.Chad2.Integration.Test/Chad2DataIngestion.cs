...
{
    public class DataIngestion : IClassFixture<Chad2TestFixture>
    {
        private readonly Chad2TestFixture fixture;
        private readonly ITestOutputHelper output;

        public DataIngestion(Chad2TestFixture fixture, ITestOutputHelper output)
        {
