...
{
    public class DataIngestion : IClassFixture<Chad1TestFixture>
    {
        private readonly Chad1TestFixture fixture;
        private readonly ITestOutputHelper output;

        public DataIngestion(Chad1TestFixture fixture, ITestOutputHelper output)
        {
